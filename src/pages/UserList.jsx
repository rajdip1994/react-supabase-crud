                ...
                <tbody>
                    {filteredUsers.map((u) => (
                        <tr key={u.id}>
                            <td>
                                {u.image ? (
                                    <img src={u.image} alt="profile" width="50" className="rounded-circle" />
                                ) : (
                                    <div className="bg-secondary text-white text-center rounded-circle" style={{ width: 50, height: 50, lineHeight: '50px' }}>
                                        {u.name.charAt(0)}
                                    </div>
                                )}
                            </td>
                            ...
                            <div className="modal-body">
                                <div className='row'>
                                    ...
                                    <div className='col-md-9'>
                                        {selectedUser.image && (
                                            <img src={selectedUser.image} style={{ maxWidth: '20%' }} className='rounded-circle' alt="" />
                                        )}
                                    </div>
                                </div>
